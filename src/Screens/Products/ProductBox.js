        ...
        return (
            ...
            >
                ...
                <View style={{ flexDirection: 'column', paddingLeft: 10 }}>
                    ...
                    <Text style={{ fontSize: 15, marginVertical: '7%' }}>Price:  {this.state.proPrice}$</Text>
                    <Text style={{ fontSize: 15 }}>Qty:  {this.state.proNum}</Text>
                </View>
                <Text style={{ fontSize: 15, marginTop: '15%', marginLeft: '20%', fontWeight:'bold' }}>Total:  {this.state.proPrice * this.state.proNum}$</Text>
            </TouchableOpacity>
        )
    }
}
